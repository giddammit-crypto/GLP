...
донских казаков** и шашки из модификации
...
- `RSR_marine*` — пехотинец-матрос (палубная/морская пехота), tag-specific
  `GLP_infantry_entity`;
- `DON_cavalry*` — верховой донской казак (модель конницы Гуляйполя; введена
  итерацией 23 вместо `NTC_cavalry*` — повстанческого всадника в чёрной папахе
  и черкеске, файлы удалены);
