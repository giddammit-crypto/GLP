...
| Шаблоны дивизий | 15 | **3 собственных плитки + 12 ванильных по составу** | — |
...
|---|---|---|---|
| 90 | `GLP_white_volunteers.dds` | знамя белогвардейских добровольцев | «Офицерская добровольческая дивизия», «Казачья добровольческая конная дивизия» |
| 91 | `GLP_spanish_volunteers.dds` | знамя CNT-FAI | «Интернациональная бригада CNT-FAI», «Испанская ударная конная колонна» |
| **92** | **`GLP_tachanka.dds`** (76×42 + 30×12, несжатый ARGB8888) | **всадник с шашкой и тачанка — конь, а не танк** | «Ударный тачаночный курень им. Батьки Махно», «Трофейный отряд РПА» |

Силуэт 92 собирается `tools/build_division_icons.sh` из мастера
`tools/_icons_src/_src_div_cavalry.png` (всадник + тачанка) и
`_src_div_cavalry_small.png` (упрощённый галоп для 30×12): плоская фигура цвета
`#517151` с верхней световой растяжкой и тёмной обводкой — стиль ванильных
дивизионных иконок; на мелкой плитке растяжка и обводка отключаются, иначе
силуэт превращается в пятно (покрытие мелкой плитки — 16 %, крупной — 37,6 %).
Знамёна 90/91 род войск намеренно не утверждают, поэтому для них соответствие
«название ↔ иконка» не проверяется.
...
|---|---|---|---|---|
| Ударный тачаночный курень им. Батьки Махно | 4 × конница, 2 × мотопехота, 1 × лёгкие танки | конь (counter 92) | конная, `GLP_CAV` | ✔ (был танк) |
| Трофейный отряд РПА | 2 × пехота, 2 × конница | конь (counter 92) | конная, `GLP_CAV` | ✔ (была пехота) |
| Казачья добровольческая конная дивизия | 4 × конница, 2 × мотопехота, 1 × лёгкие танки | знамя 90 | конная, `GLP_CAV` | ✔ знамя |
| Испанская ударная конная колонна | 4 × конница, 2 × мотопехота, 1 × лёгкие танки | знамя 91 | конная, `GLP_CAV` | ✔ знамя |
