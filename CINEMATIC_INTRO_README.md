...
- **Исходник:** `sound/voice.ogg` (OGG Vorbis, 44.1 kHz, 1 ch, ~13 сек.).
- **Текст рассказчика:** «В этой модификации, созданной Амброзиевым Олегом, вы берёте на себя управление Гуляйпольской республикой, и только от ваших решений зависит её дальнейшая судьба! Вперёд, Батько!»
...
- [x] Центр — текстовый блок с плавной кинематографической прокруткой снизу вверх (прозрачная подложка, альфа-маска затухания, вертикальное направление) и режимом ручного чтения
