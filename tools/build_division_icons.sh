...
#    приказать движку рисовать нужную иконку через template_counter.
#
...
# -- конница РПА / тачанка (counter 92) --------------------------------------
build_one "$SRC/_src_div_cavalry.png"       76 42 1 yes "$OUT_L/GLP_tachanka.dds"
build_one "$SRC/_src_div_cavalry_small.png" 30 12 0 no  "$OUT_S/GLP_tachanka.dds"
